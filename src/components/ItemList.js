    ...
    <div className={`flex flex-col justify-start items-start px-4   `}>
      {itemCards.map((item) => (
        <div
          ...
          className="flex justify-between flex-col sm:flex-row items-center p-2 m-2 border-b-2 border-gray-300 w-full gap-2 hover:bg-gray-200  bg-gray-100 rounded-lg"
        >
